// Content script for Mon CV extension
...
function fillField(selector, value) {
  ...
  if (!el) {
    console.warn(`[Mon CV] Element not found: ${selector}`);
    return false;
  }
  ...
  try {
    ...
    console.error(`[Mon CV] Error filling ${selector}:`, err);
    return false;
  }
}
...
console.log('[Mon CV] Content script loaded');
